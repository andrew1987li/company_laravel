...
@section('title')
    Talent Team around the world
@endsection
    
<!--This is for meta data   -->
@section('metadescription','talent team supports the good services and portofolio')
@section('metaauthor','Andrew Li')
...
@section('content')
    <section id="main-slider" class="no-margin">
        <input type="hidden" name="pgid" value="mnu0">    
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">The senior Developer in Web&Mobile</h1>
                                    <h2 class="animation animated-item-2">In a short time, you will get the successful result...</h2>
                ...
                <div class="item" style="background-image: url(/assets/images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">The talented developers all around the world</h1>
                                    <h2 class="animation animated-item-2">The professional knowleges about web and mobile development...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(/assets/images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">The trusted Services and Excellent compatiability</h1>
                                    <h2 class="animation animated-item-2">Our team supports the SEO, Web&Mobile development and Ask&Questions...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
    ...
    <section id="partner">
        <div class="container">
            ...
            <div class="partners">
                <ul>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="assets/images/partners/partner1.png"></a></li>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" src="assets/images/partners/partner2.png"></a></li>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms" src="assets/images/partners/partner3.png"></a></li>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1200ms" src="assets/images/partners/partner4.png"></a></li>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1500ms" src="assets/images/partners/partner5.png"></a></li>
                </ul>
            </div>        
        </div><!--/.container-->
    </section><!--/#partner-->
